...
import { metersToKilometers } from "@/utils/metersToKillometer";
import axios from "axios";
import { format, fromUnixTime, parseISO } from "date-fns";
// https://api.openweathermap.org/data/2.5/forecast?q=Colombo&appid=a4258508d58a7c75037cffade561c7b8&cnt=56
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col gap-4 bg-gray-100 min-h-screen">
      ...
      <main className="px-3 max-w-7xl mx-auto flex flex-col gap-9 w-full pb-10 mt-10">
        {loadingCity ? (
          <WeatherSkeleton />
        ) : (
          <>
                ...
                <Container className="gap-10 px-6 items-center">
                  <div className="flex flex-col px-4">
                    <span className="text-5xl">
                      {convertKelvinToCelsius(firstData?.main.temp ?? 293.37)}°
                    </span>
